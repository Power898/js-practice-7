...
function createSymbol() { const symbolkey= Symbol(); console.log(symbolkey);
...
function getSymbolKey(symbol) { const key=Symbol.keyFor(symbol); console.log(key);
...
let rangeObject = {
  ...
  // та не забуваємо збільшити індекс за допомогою інкремент, і "done" - false, означаючи, else що ітерація ще не закінчена
